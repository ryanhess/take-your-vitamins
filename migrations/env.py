...
# Add the backend directory to system path
...
# Auto-discover all `models` modules under so their ORM classes
...
for _importer, module_name, _ispkg in pkgutil.walk_packages(
    path=[str(backend_directory)],
):
    if module_name == "models" or module_name.endswith(".models"):
